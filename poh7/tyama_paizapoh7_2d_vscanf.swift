...
var	a=0,b=0,c=0,d=0
withUnsafeMutablePointer(&a){(p) in withVaList([COpaquePointer(p)]){(va) in vscanf("%d",va)}}
withUnsafeMutablePointer(&b){(p) in withVaList([COpaquePointer(p)]){(va) in vscanf("%d",va)}}
withUnsafeMutablePointer(&c){(p) in withVaList([COpaquePointer(p)]){(va) in vscanf("%d",va)}}
withUnsafeMutablePointer(&d){(p) in withVaList([COpaquePointer(p)]){(va) in vscanf("%d",va)}}
